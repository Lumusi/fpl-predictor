          ...
          <div className="flex items-center gap-3">
            ...
            {onRefresh && (
              <button 
                onClick={onRefresh}
                disabled={loading}
                className="flex items-center bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-600 text-white px-4 py-2 rounded-md shadow transition-colors"
              >
                {loading ? (
                  <>
                    <svg 
